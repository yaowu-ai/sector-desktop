...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::load_browser_window_settings,
            commands::settings::get_initialization_status,
            commands::settings::save_system_settings,
            commands::settings::save_browser_window_settings,
            ...
            commands::bitbrowser::check_ixbrowser_api,
            ...
            commands::bitbrowser::list_ixbrowser_profiles,
            commands::bitbrowser::get_profile_status,
            commands::bitbrowser::open_profile,
            commands::bitbrowser::open_ixbrowser_profile,
            commands::bitbrowser::close_profile,
            commands::bitbrowser::close_ixbrowser_profile,
            ...
            commands::stats::query_profile_stats_latest,
            commands::stats::query_profile_stats_history,
            commands::stats::query_profile_stats_detail,
            commands::stats::query_profile_stats_summary,
